...
extension UIColor {
    ...
    public static var random: UIColor {
        let pick = Int(arc4random_uniform(6))
        var color: UIColor!
        switch pick {
        case 0:
            color = UIColor.init(hexString: "702A63")
        case 1:
            color = UIColor.init(hexString: "04CBCB")
        case 2:
            color = UIColor.init(hexString: "7EF1F1")
        case 3:
            color = UIColor.init(hexString: "00B3B3")
        case 4:
            color = UIColor.init(hexString: "A9709E")
        case 5:
            color = UIColor.init(hexString: "6C6986")
        case 6:
            color = UIColor.init(hexString: "3A425E")
        default:
            break
        }
        return color
